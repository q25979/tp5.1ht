...
class Rbac
{
    ...
    public function menu()
    {
        ...
        $str = "<tr id='node-\$id' \$parent_id_node>
                    <td>
                        <input name='listorders[\$id]' type='text' size='3' value='\$list_order' data='\$id' class='layui-input listOrder'>
                    </td>
                    ...
                    <td class='str-manage'>\$str_manage</td>
                </tr>";
    ...
    protected function authorizeHtml($menu,$type,$authMenu=[])
    {
        ...
        foreach ($menu as $n => $t) {
            ...
            if ($menu[$n]['width'] == 99) $menu[$n]['width'] = 96;
